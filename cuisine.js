const LETTRE_PROPOSEE = document.getElementById("lettreProposee2");
const MOT_PROPOSE = document.getElementById("motPropose2"); 
const SEND_LETTRE = document.getElementById("sendLettreProposee2");
const SEND_MOT = document.getElementById("sendMotPropose2");
